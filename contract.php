...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom('sairampenkey09@gmail.com', 'Cocofarms'); // Your Gmail email and name
        $mail->addAddress('sairampenkey09@gmail.com', 'Cocofarms'); // Recipient's email and name
